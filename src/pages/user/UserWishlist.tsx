...
export default function UserWishlist() {
  ...
  const addToCartMutation = useMutation({
    mutationFn: (item: any) => userAPI.addToCart({ menuItemId: item._id, quantity: 1 }),
    onSuccess: () => {
  ...
  return (
    <UserLayout>
      <div className="container mx-auto px-4 py-8">
        ...
        {isLoading ? <LoadingSpinner text="Loading wishlist..." /> : wishlist.length === 0 ? (
          <div className="text-center py-16">
            <Heart size={48} className="mx-auto text-muted-foreground mb-4" />
            <h2 className="text-xl font-semibold text-foreground mb-2">Your wishlist is empty</h2>
            <p className="text-muted-foreground mb-4">Save your favorite dishes here</p>
            ...
            {wishlist.map((item: any) => (
              <div key={item._id} className="food-card overflow-hidden group">
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3"><VegBadge isVeg={item.isVeg} /></div>
                  <button
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Button size="sm" variant="gradient" onClick={() => addToCartMutation.mutate(item)} className="gap-1">
